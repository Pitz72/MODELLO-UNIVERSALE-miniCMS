// =====================================================================
// TYPOGRAPHIC GRID — "React + PHP: The Thin Stack" (EN, US edition)
// Technical manual, KDP 7x10", B/W. Engine: Typst. v0.2 (EN variant of template.typ)
//   lvl.1 = Part (hidden heading, outline only)
//   lvl.2 = Chapter   lvl.3 = section   lvl.4 = subsection
// =====================================================================
...
#let part(num, title, desc) = {
  ...
  align(center + horizon)[
    #if num != none [#text(size: 12pt, tracking: 3pt, fill: luma(90))[PART #num] #v(0.8em)]
...
#let conf(doc) = {
  ...
  set text(font: "IBM Plex Serif", size: 10pt, lang: "en", region: "US", hyphenate: true)
