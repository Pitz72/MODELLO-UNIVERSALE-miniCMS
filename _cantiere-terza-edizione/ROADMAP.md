...
- [ ] **FASE 3 / CAP 6 Frontend Bridge (API.ts)** (PROSSIMA card) — riscrittura chirurgica: il nome "Double Read" è sbagliato (≠ response-cloning); CSRF lato client (token in-memory SR); guard loader-vs-componente; messaggio backend perso (login 429); niente interceptor 401. Fonti S1-C3. Vedi `PROSSIMA-SESSIONE.md`.
...
- **Fase corrente:** 🟨 **FASE 3 — SCRITTURA in corso** (6/9: **CAP 10 ✅ · 8 ✅ · 11 ✅ · 12 ✅ · 13 ✅ · 14-NUOVO ✅** — filo 4 emettitori COMPLETO · **rinumerazione Parte V +1 ESEGUITA**, ora 20 capitoli fisici). FASE 2 conclusa (S1 14/14 · S2 · S3 · S4 gate superato 2026-06-19). FASE 1 conclusa (4 siti, 34 card). Target: 20 capitoli + 2 appendici, riscritture chirurgiche.
- **Prossima unità:** **FASE 3 / CAP 6 Frontend Bridge (API.ts)** — riscrittura chirurgica (Double Read corretto ≠ response-cloning; CSRF client; guard loader-vs-componente; messaggio backend perso; no interceptor 401). Fonti: S1-C3. Ordine completo in `sintesi/S3-scaletta-globale.md` §8. Vedi `PROSSIMA-SESSIONE.md`.
- **Log completo:** `LOG.md`.
