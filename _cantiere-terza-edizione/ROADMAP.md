...
- [ ] **FASE 3 / CAP 13 Newsletter & Email System** (PROSSIMA card) — riscrittura chirurgica: **chiude DEFINITIVAMENTE il filo dei 4 emettitori** (nessuno emette content); double opt-in a 3 gradini; rate-limit≠throttle + mail-bombing SR; SMTP/PHPMailer vs mail() nuda; header-injection via name DIS; unsubscribe-by-email NON GDPR-compliant. Fonti S1-C9. Vedi `PROSSIMA-SESSIONE.md`.
...
- **Fase corrente:** 🟨 **FASE 3 — SCRITTURA in corso** (4/9 riscritture: **CAP 10 ✅ · CAP 8 ✅ · CAP 11 ✅ · CAP 12 ✅**). FASE 2 conclusa (S1 14/14 · S2 · S3 · S4 gate superato 2026-06-19). FASE 1 conclusa (4 siti, 34 card). Target: 20 capitoli + 2 appendici, riscritture chirurgiche.
- **Prossima unità:** **FASE 3 / CAP 13 Newsletter & Email System** — riscrittura chirurgica (chiude DEFINITIVAMENTE il filo dei 4 emettitori; double opt-in 3 gradini; rate-limit≠throttle + mail-bombing SR; SMTP vs mail(); header-injection DIS; unsubscribe non GDPR). Fonti: S1-C9. Ordine completo in `sintesi/S3-scaletta-globale.md` §8. Vedi `PROSSIMA-SESSIONE.md`.
- **Log completo:** `LOG.md`.
