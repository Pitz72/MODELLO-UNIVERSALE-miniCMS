...
- [ ] **FASE 3 / CAP 12 RSS Feed & Syndication** (PROSSIMA card) — riscrittura chirurgica: il feed è l'emettitore PIÙ sicuro del content (non lo emette o lo escapa → **chiude il filo dei 4 emettitori**); feed-podcast = DIS non SR; proxy CORS inbound; `feed_config` security-theater; catch-vuoto = anti-pattern; GUID URN. Fonti S1-C8. Vedi `PROSSIMA-SESSIONE.md`.
...
- **Fase corrente:** 🟨 **FASE 3 — SCRITTURA in corso** (3/9 riscritture: **CAP 10 ✅ · CAP 8 ✅ · CAP 11 ✅**). FASE 2 conclusa (S1 14/14 · S2 · S3 · S4 gate superato 2026-06-19). FASE 1 conclusa (4 siti, 34 card). Target: 20 capitoli + 2 appendici, riscritture chirurgiche.
- **Prossima unità:** **FASE 3 / CAP 12 RSS Feed & Syndication** — riscrittura chirurgica (il feed è l'emettitore PIÙ sicuro del content → chiude il filo dei 4 emettitori; feed-podcast=DIS non SR; proxy CORS inbound; feed_config security-theater; catch-vuoto=anti-pattern; GUID URN). Fonti: S1-C8. Ordine completo in `sintesi/S3-scaletta-globale.md` §8. Vedi `PROSSIMA-SESSIONE.md`.
- **Log completo:** `LOG.md`.
