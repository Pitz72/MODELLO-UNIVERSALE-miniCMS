...
- [ ] **FASE 3 / CAP 11 SEO Pre-rendering** (PROSSIMA card) — riscrittura chirurgica: Dynamic Rendering vs SSG-scartato; il **buco XSS-attributi** del prerender (qui il filo dei 4 emettitori mostra la falla viva); SEO indicizza le bozze; seo-cache morta SR; accogliere il DDoS-da-bot dal vecchio CAP 10 §6. Fonti S1-C7 + S1-C2 §6. Vedi `PROSSIMA-SESSIONE.md`.
...
- **Fase corrente:** 🟨 **FASE 3 — SCRITTURA in corso** (2/9 riscritture: **CAP 10 ✅ · CAP 8 ✅**). FASE 2 conclusa (S1 14/14 · S2 · S3 · S4 gate superato 2026-06-19). FASE 1 conclusa (4 siti, 34 card). Target: 20 capitoli + 2 appendici, riscritture chirurgiche.
- **Prossima unità:** **FASE 3 / CAP 11 SEO Pre-rendering** — riscrittura chirurgica (Dynamic Rendering vs SSG-scartato; il buco XSS-attributi del prerender = il filo dei 4 emettitori che mostra la falla viva; bozze indicizzate; seo-cache morta SR; DDoS-da-bot dal vecchio CAP 10 §6). Fonti: S1-C7 (princ.) + S1-C2 §6. Ordine completo in `sintesi/S3-scaletta-globale.md` §8. Vedi `PROSSIMA-SESSIONE.md`.
- **Log completo:** `LOG.md`.
